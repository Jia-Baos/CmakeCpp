...
int main()
{
    ...
    saveWeights("./fc1.wts", fc1_weight_data, 6);
    saveWeights("./fc1.bias", fc1_bias_data, 2);

    // 读取权重
    auto fc1_weight_vec = loadWeights("./fc1.wts");
    auto fc1_bias_vec = loadWeights("./fc1.bias");
    ...
    // 存入文件
    std::ofstream outfile("./mlp.engine", std::ios::binary);
